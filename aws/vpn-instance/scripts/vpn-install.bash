...
EOF
  ...
  curl -u elastic:$ELK_PASSWORD -f -X POST -H 'Content-Type: application/json' -H 'kbn-xsrf: anything' http://$ELK_ADDRESS:5601/api/saved_objects/index-pattern '-d{"attributes":{"title":"'"$ELK_VPN_INDEX"'","timeFieldName":"timestamp"}}'
}
